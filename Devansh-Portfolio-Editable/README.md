# Devansh Mishra — Editable Motion Portfolio
...
1. Duplicate the folder and rename the copy.
2. Change identity text and social links.
3. Replace project content and artwork.
4. Adjust colours in `app/globals.css`.
5. Run `npm run dev` and check desktop and mobile widths.
6. Run `npm run lint` and `npm run build`.
7. Deploy using your own hosting account and database.
